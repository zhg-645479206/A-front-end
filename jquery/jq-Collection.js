(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global.activeAssembly = factory());
}(this, (function() {
    'use strict';
    var activeAssembly = {
        dialog: {},
    ...
    activeAssembly.detailsFrame = function(params) {
            ...
            return this.each(function() {
                var _html = '<div id=' + options.id + '><div class="weiyi">' + '<p class="title">' + options.title + '<span class="weiyi-close">X</span>' + '<span class="weiyi-explain">图标</span>' + '</p>' + '<div class="contentbox">' + '<div class="content">' + '</div>' + '<p class="btn-footer">' + '<button id="btn">' + options.btn.name + '</button>' + '</p></div></div></div>';
